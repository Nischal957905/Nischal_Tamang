...
const DevelopPage = () => {
  ...
  return (
    <div className="bg-[#2C2C2C] text-[#FFFFFF] pr-5 pl-5 sm:h-[100svh]">
      <h1 className="text-center text-[26px] font-semibold pt-6 pb-6 sm:h-[18svh] m:pt-0 sm:pb-0 sm:flex sm:items-center sm:justify-center">Some of My Works</h1>
      <div className='sm:flex sm:justify-center sm:items-center sm:h-[82svh] sm:flex-col'>
        ...
        <div className='text-end sm:w-full sm:pt-5 pb-5'><Link href='https://github.com/Nischal957905' target='_blank' className='text-end text-[#0C8CE9]'>|More on Github|</Link></div>
      </div>
    </div>
  )
}
