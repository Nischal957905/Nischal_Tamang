      ...
      <div className="sm:flex sm:flex-col sm:items-center sm:justify-center sm:h-[85svh]">
        <div className="sm:flex sm:flex-row-reverse sm:w-[60svw] sm:mb-4">
          ...
          <div className="sm:pr-10">
            ...
            <p className="text-[14px] font-semibold leading-tight pr-5 sm:pr-0 sm:max-w-[40svw]">I design both front-end and back-end websites. With the skills I have accumulated over more than 6 years of my software engineering journey, I build seamless applications.</p>
            <p className="text-[14px] font-semibold leading-tight pt-4 pr-5 sm:pr-0 sm:max-w-[40svw]">I expertise in node alongside modern frameworks like react, next and express. Check below whether I am fit for your work or not.</p>
          </div>
        </div>
